  ...
  static async fetchAll() {
    try {
      const [compras] = await db.query(`
              SELECT IDCompra, C.IDCliente, Cl.Nombre AS nombreCliente, Cl.Correo, C.IDProducto, P.Nombre AS nombreProducto, Fecha AS fechaCompra, E.IDEncuesta, E.Titulo AS tituloEncuesta
              FROM compra C
