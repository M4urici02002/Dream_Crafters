...
exports.post_diasParaEnvio = (request, response, next) => {
  Encuesta.update(request.body.diasParaEnvio, request.body.IDEncuesta)
    .then(([rows, fieldData]) => {
      // Redirigir al usuario de vuelta a crear encuesta una vez que la actualización se complete con éxito
